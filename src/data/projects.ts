...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: {
      en: 'BreastFriend is a platform built during the “Hack For Good With Gen AI” hackathon, which won the Business Impact Prize. It supports women before, during and after breast cancer and connects them with their doctor: a medical RAG chatbot over an oncology corpus, wig recommendation through computer vision, and a complete patient–doctor follow-up workflow.',
      fr: "BreastFriend est une plateforme réalisée lors du hackathon « Hack For Good With Gen AI », lauréate du Prix Business Impact. Elle accompagne les femmes avant, pendant et après un cancer du sein et fait le lien avec leur médecin : chatbot médical RAG sur corpus d'oncologie, recommandation de perruques par vision par ordinateur et suivi patiente–médecin complet.",
    },
    problem: {
    ...
    solution: {
      en: 'A patient space (guided self-exam, RAG-generated questionnaire, AI assistant, wig recommendation) and a doctor space (dashboard, reports with triage levels, calendar, notifications, messaging and a medical corpus that feeds the RAG). The chatbot cites its sources, detects emergencies and refuses to invent an answer when the corpus has no reliable information.',
      fr: "Un espace patiente (autopalpation guidée, questionnaire généré par RAG, assistante IA, recommandation de perruques) et un espace médecin (tableau de bord, comptes rendus avec niveaux de triage, agenda, notifications, messagerie et corpus médical alimentant le RAG). Le chatbot cite ses sources, détecte les urgences et refuse d'inventer une réponse lorsque le corpus ne contient pas d'information fiable.",
    },
    highlight: {
    ...
    features: [
      'Medical RAG chatbot with cited sources and emergency detection (fever during chemotherapy → urgent alert)',
      'Wig recommendation by computer vision: face shape, skin tone and undertone analysis, ranked suggestions',
      'Guided self-exam and RAG-generated follow-up questionnaire with explainable triage (reassuring / to monitor / priority)',
      'Doctor dashboard: structured reports (PDF), calendar, notifications, messaging and private notes',
      'Editable medical corpus (PDF / Markdown / text) indexed instantly for the assistant',
    ],
    technologies: ['Python', 'Flask', 'RAG', 'NLP', 'OpenCV', 'React.js'],
    repositoryType: 'private',
